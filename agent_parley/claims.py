"""Issue claims, offers, handoffs and the advisory work-order plan.
...
class ClaimsMixin(ReportsMixin):
    ...
    Lists, claims, offers, releases and resolves issues in the project
    ledger, ranks and matches candidates a lane could claim next, forecasts
    reservation collisions from earlier pull requests, and applies or
    compares the advisory work-order plan.
    """
    ...
    def _claim_forecast(
        ...
        from agent_parley.cli import forecast, forge, store
    ...
    def issue_match(
        ...
        from agent_parley.cli import forge, git, roster, snapshot, store
    ...
    def issue_assign(
        ...
        *,
        ...
        """
        from agent_parley.cli import change, parse_issue, roster
    ...
    def _request_notice(
        ...
        """
        from agent_parley.cli import operator_key, store
