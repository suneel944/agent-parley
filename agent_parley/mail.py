...
they run, so a name bound or replaced there is the one a moved method
reads. This module never imports `cli` at import time.
"""
...
from agent_parley import BridgeError, store
from agent_parley.core import BridgeCore


class MailMixin(BridgeCore):
    ...
    def acknowledge(self, repo: Path, identifier: int) -> dict:
        ...
        """
        from agent_parley.cli import roster, store
        ...
        *,
        ...
        Raises:
            BridgeError: If the lane, the named participant or its registered
                identity is unknown.
        """
        from agent_parley.cli import attachments, git, roster, store
    ...
    def decide(
        ...
        Raises:
            BridgeError: If the repository has no project or the decision
                fails validation.
        """
        from agent_parley.cli import operator_key, roster, store
    ...
    def decisions(
        ...
        """
        from agent_parley.cli import git, roster, store
