...
from agent_parley.worktrees import Worktrees, exact_claim, git
...
if TYPE_CHECKING:
    ...
    from agent_parley.checkpoints import read_events
    ...
    retries = deferred("retries")
    roster = deferred("roster")
    state = deferred("state")
    read_events = DeferredCallable(checkpoints, "read_events")
    change_attempt = DeferredCallable(issues, "attempt")
...
class Reports(Worktrees):
    """Records reports and verdicts and reads the project's history."""
