"""Reports and records the per-project settings kept beside the roster."""
...
if TYPE_CHECKING:
    ...
    from agent_parley import approvals, budgets, forge, roster, state, store
...
class Settings(Worktrees):
    """Reads and writes the settings a project records in its manifest."""
